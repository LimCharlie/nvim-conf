return {
  ...
  config = function()
    ...
    local on_attach_callback = function(client, buffer)
      vim.keymap.set("n", "<leader>gD", vim.lsp.buf.declaration, { desc = "Go to declaration", buffer = buffer })
      vim.keymap.set("n", "<leader>gd", vim.lsp.buf.definition, { desc = "Go to definition", buffer = buffer })
      ...
      vim.keymap.set("n", "<leader>gr", vim.lsp.buf.references, { desc = "Go to References", buffer = buffer })
    end
